...
public class HouseTable {
	...
	// Current List of IDs
	private static List<String> currentIDStore;
	...
	/**
	 * Get IDs for regarding current table;
	 * 
	...
	private void populateTable() {
		...
		dataProvider = new AsyncDataProvider<HouseData>() {
			...
			protected void onRangeChanged(HasData<HouseData> display) {
				...
				houseDataSvc.getHouses(currentIDStore, currentStartItem, range,
						callback);
			}
		};
	...
	private void createSort() {
		...
		AsyncHandler columnSortHandler = new ColumnSortEvent.AsyncHandler(
			...
			public void onColumnSort(ColumnSortEvent event) {
				...
				switch (columnIndex) {
				case 0:
					houseDataSvc.sortByAddress(isSortAscending, currentIDStore,
							callback);
					break;
				case 1:
					houseDataSvc.sortByPostalCode(isSortAscending,
							currentIDStore, callback);
					break;
				case 2:
					houseDataSvc.sortByCurrentLandValue(isSortAscending,
							currentIDStore, callback);
					break;
				case 3:
					houseDataSvc.sortByCurrentImprovementValue(isSortAscending,
							currentIDStore, callback);
					break;
				case 4:
					houseDataSvc.sortByAssessmentYear(isSortAscending,
							currentIDStore, callback);
					break;
				case 5:
					houseDataSvc.sortByPreviousLandValue(isSortAscending,
							currentIDStore, callback);
					break;
				case 6:
					houseDataSvc.sortByPreviousImprovementValue(
							isSortAscending, currentIDStore, callback);
					break;
				case 7:
					houseDataSvc.sortByYearBuilt(isSortAscending,
							currentIDStore, callback);
					break;
				case 8:
					houseDataSvc.sortByBigImprovementYear(isSortAscending,
							currentIDStore, callback);
					break;
				case 9:
					houseDataSvc.sortByOwner(isSortAscending, currentIDStore,
							callback);
					break;
				case 10:
					houseDataSvc.sortByPrice(isSortAscending, currentIDStore,
							callback);
					break;
				case 11:
					houseDataSvc.sortByForSale(isSortAscending, currentIDStore,
							callback);
					break;
				default:
					break;
	...
	public void refreshTableFromBeginning() {
		...
		houseDataSvc.getHouses(currentIDStore, 0, pageLength, callback);
	}
	...
	public void refreshTableCurrentView() {
		...
		houseDataSvc.getHouses(currentIDStore, currentStartItem, pageLength,
				callback);
	}
