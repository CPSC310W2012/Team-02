...
public class HouseDataServiceTests {
	...
	public static void setUp() throws Exception {
		...
		currentIDStore = service.refreshIDStore();
	}
	...
	public void testSearchPerformWorst() {
		...
		String[] userSearchInput = { "", "", "0", "999999999", "0",
				...
				"999999999", "0", "999999999", "0", "999999999", "0",
				"999999999" };
		currentIDStore = service.searchHouses(userSearchInput, -1);
		assertTrue(currentIDStore.size() > 0);
	}
	...
	public void testSearchMultiple() {
		...
		String[] userSearchInput1 = { "4203", "13TH AVE W", "", "", "", "", "",
				"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
				"" };
		currentIDStore = service.searchHouses(userSearchInput1, -1);
		assertTrue(currentIDStore.size() > 0);

		String[] userSearchInput2 = { "", "", "", "", "", "", "", "", "10",
				"1000", "", "", "", "", "", "", "", "", "", "", "", "", "", "" };
		currentIDStore = service.searchHouses(userSearchInput2, -1);
		assertTrue(currentIDStore.size() > 1);
	}
}
